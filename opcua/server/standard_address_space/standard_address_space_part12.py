...
def create_standard_address_space_Part12(server):
    ...
    extobj = ua.EnumValueType()
    extobj.Value = 1
    extobj.DisplayName.Text = b'TrustedCertificates'
    value.append(extobj)
    extobj = ua.EnumValueType()
    extobj.Value = 2
    extobj.DisplayName.Text = b'TrustedCrls'
    value.append(extobj)
    extobj = ua.EnumValueType()
    extobj.Value = 4
    extobj.DisplayName.Text = b'IssuerCertificates'
    value.append(extobj)
    extobj = ua.EnumValueType()
    extobj.Value = 8
    extobj.DisplayName.Text = b'IssuerCrls'
    value.append(extobj)
    extobj = ua.EnumValueType()
    extobj.Value = 15
